...
<link rel="stylesheet"
          href="https://willdarkmode.github.io/DM-Dashboard/css/dashboard.css?v=2.28.5"
          onerror="console.error('[DM-DASHBOARD] Falha ao carregar dashboard.css remoto.')" />
    <!-- V2.28.5: CSS consolidado (Visão Geral + módulos + navegação) -->
</head>
<body>
<div class="dm-app">
    ...
    <main class="dm-content">
        ...
        <!-- 5. ESTOQUE & COMPRAS — V2.28.5 / Inteligência de Estoque -->
        ...
        <!-- 6. SEXTO SENTIDO — V2.28.5 / Central de Inteligência -->
...
-->
<!-- V2.28.5: módulo Estoque carregado antes do core para restaurar a aba corretamente -->
<script src="https://willdarkmode.github.io/DM-Dashboard/js/stock.js?v=2.28.5"
        charset="UTF-8"
        onerror="console.error('[DM-DASHBOARD] Falha ao carregar stock.js remoto.');"></script>
<script src="https://willdarkmode.github.io/DM-Dashboard/js/intelligence.js?v=2.28.5"
        charset="UTF-8"
        onerror="console.error('[DM-DASHBOARD] Falha ao carregar intelligence.js remoto.');"></script>
<script src="https://willdarkmode.github.io/DM-Dashboard/js/dashboard.js?v=2.28.5"
        charset="UTF-8"
